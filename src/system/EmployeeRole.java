...
public class EmployeeRole{
	...
	public void addProduct(String productID, String productName, String manufacturerName, String supplierName, int quantity,
                float price){
            Product item = new Product(productID, productName, manufacturerName, supplierName, quantity, price);
	...
	public double returnProduct(String customerSSN, String productID, LocalDate purchaseDate ,LocalDate returnDate){
            ...
            if(purchaseDate.until(currentDate).getDays() < 14 || purchaseDate.until(returnDate).getDays() < 0)
                return -1;
	...
	public boolean applyPayment(String customerSSN, LocalDate purchaseDate){
            for(CustomerProduct product : customerProductDatabase.returnAllRecords()){
                if(product.getCustomerSSN().equals(customerSSN) && product.getPurchaseDate() == purchaseDate){
